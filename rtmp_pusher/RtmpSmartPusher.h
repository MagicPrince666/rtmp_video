...
class RtmpSmartPusher
{
	...
	private:
		...
		bool sendPacket(unsigned int nPacketType,unsigned char *data,unsigned int size,unsigned int nTimestamp, unsigned int channel);
	...
	private:
		...
		pthread_t m_audioProductThread;
		...
		static bool b_need_clear_queue;
